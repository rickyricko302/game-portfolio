...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1268: x0 => ({navigationUI: x0}),
      _1269: (x0,x1) => x0.requestFullscreen(x1),
      _1270: (x0,x1) => x0.lock(x1),
      _1272: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1273: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _1274: (x0,x1) => x0.createElement(x1),
      _1281: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1289: () => new AudioContext(),
      _1290: (x0,x1) => x0.createMediaElementSource(x1),
      _1291: x0 => x0.createStereoPanner(),
      _1292: (x0,x1) => x0.connect(x1),
      _1293: x0 => x0.load(),
      _1294: x0 => x0.remove(),
      _1295: x0 => x0.play(),
      _1296: x0 => x0.pause(),
      ...
      _1510: (o, p) => o[p],
      _1513: x0 => x0.random(),
      _1514: (x0,x1) => x0.getRandomValues(x1),
      _1515: () => globalThis.crypto,
      ...
      _2303: (x0,x1) => x0.crossOrigin = x1,
      _2306: (x0,x1) => x0.preload = x1,
      _2310: x0 => x0.currentTime,
      _2311: (x0,x1) => x0.currentTime = x1,
      _2312: x0 => x0.duration,
      _2317: (x0,x1) => x0.playbackRate = x1,
      _2326: (x0,x1) => x0.loop = x1,
      _2330: (x0,x1) => x0.volume = x1,
      _2347: x0 => x0.code,
      _2348: x0 => x0.message,
      _3396: () => globalThis.window,
      _3458: x0 => x0.navigator,
      _3462: x0 => x0.screen,
      _3847: x0 => x0.userAgent,
      _5445: x0 => x0.destination,
      _6000: x0 => x0.signal,
      _6074: () => globalThis.document,
      _6135: x0 => x0.documentElement,
      _7834: x0 => x0.value,
      _7836: x0 => x0.done,
      _8538: x0 => x0.url,
      _8540: x0 => x0.status,
...
"maxValue",
"Mulai Petualangan",
"Gunakan keyboard panah / joystick untuk bergerak. Spasi untuk melakukan aksi.",
"max",
"loose",
...
"noRepeat",
"medium",
"assets/images/png/background.webp",
"FilterQuality.",
"ImageRepeat.",
"BoxFit.",
...
"setAudioContext",
"log",
"Setting AudioContext is not supported on Web",
"playback",
...
"], [",
"])",
"_sizeBackgroundDirection",
"_visibleWorldRect",
"fitWidth",
"fitHeight",
"fit",
"InitialMapZoomFitEnum.",
"_paints",
"nextIteration",
"_prefix",
"orthogonal",
"Bonfire have only suport to orthogonal orientation.",
"(TiledWorldBuilder) Error: ",
"collision",
"0xFF",
"TiledObjectProperties{position: ",
", size: ",
", rotation: ",
", type: ",
", name: ",
...
"DOWN",
"sword-hit.mp3",
"character/Basic Charakter Actions.png",
"frames",
"PLAYER_OR_ALLY",
"AttackOriginEnum.",
"onRemove",
...
"NONE",
"WORLD",
"AcceptableAttackOriginEnum.",
"lowLatency",
"setPlayerMode",
"playerMode",
"PlayerMode.",
"texting.mp3",
"Ini adalah papan informasi tentang saya, kamu dapat menekan tautan berikut yaa.",
"LEFT",
"LinkedIn: Ricky Verdiyanto\n",
"Github: Ricky Verdiyanto\n",
"WhatsApp: +6289503932319\n",
"Instagram: @rickyverdiyanto\n",
"Email: verdiyantorky123@gmail.com",
"Terima kasih sudah melihat-lihat yaa!",
"Dismiss",
...
"mailto:verdiyantorky123@gmail.com",
"platformDefault",
"inAppWebView",
"inAppBrowserView",
...
"externalApplication",
"LaunchMode.",
"https://www.instagram.com/rickyverdiyanto",
"https://api.whatsapp.com/send?phone=6289503932319",
"https://github.com/rickyricko302",
"https://www.linkedin.com/in/rickyverdiyanto",
"Halo, selamat datang di portofolio saya.",
"Salam kenal saya Ricky Verdiyanto, biasa dipanggil Ricky.",
"Saya adalah seorang Mobile Developer dengan pengalaman 3 tahun lebih yang fokus pada pengembangan aplikasi menggunakan Flutter.",
"Kamu bisa melihat lebih lanjut tentang saya dengan berinteraksi papan informasi di sekitar.",
"ActionEvent.",
"UP",
"_viewport",
"_viewPort",
...
"_game",
"There is not a WorldMapReader.asset to ",
"assets/images/tiled/map_tiled.json",
"basePath",
"spritesheet.png",
".json",
".tmj",
...
"zlib",
"gzip",
"Only supports zlib/gzip compression.",
"JQ==",
"Jg==",
"Jw==",
"KA==",
...
",\n)",
"Vector2(",
"Kamu mau mengundang banjir dan tanah longsor dengan menebang pohon?",
"Atau mau diganti pohon sawit?",
"Menebang pohon secara sembarangan itu tidak baik.",
"png/board-info.png",
"png/board-profile.png",
"SensorContact",
"character/NPC_01.png",
"Hei itu rumahku, kamu tidak bisa masuk ke dalam.",
"character/Free Cow Sprites.png",
"INTERVAL_RANDOM_MOVEMENT",
"_random",
"character/NPC_02.png",
"Oi! Jangan sakiti aku!",
